...
const LinkedInPlaceholder_1 = require("../placeholders/LinkedInPlaceholder");
const uuid_1 = require("../uuid");
const EmbedStyle_1 = require("./EmbedStyle");
const LinkedInEmbed = (_a) => {
    var _b, _c;
    var { postUrl, url, width, height = 500, embedPlaceholder, placeholderDisabled, placeholderImageUrl } = _a, divProps = __rest(_a, ["postUrl", "url", "width", "height", "embedPlaceholder", "placeholderDisabled", "placeholderImageUrl"]);
    const uuidRef = React.useRef((0, uuid_1.generateUUID)());
    const [ready, setReady] = React.useState(false);
    const placeholder = embedPlaceholder !== null && embedPlaceholder !== void 0 ? embedPlaceholder : (React.createElement(LinkedInPlaceholder_1.LinkedInPlaceholder, { url: postUrl !== null && postUrl !== void 0 ? postUrl : url, style: {
