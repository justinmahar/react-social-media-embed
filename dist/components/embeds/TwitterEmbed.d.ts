...
export declare const TwitterEmbed: ({ url, twitterTweetEmbedProps, width, height, embedPlaceholder, placeholderDisabled, placeholderImageUrl, ...divProps }: TwitterEmbedProps) => JSX.Element;
