...
exports.LinkedInPlaceholder = void 0;
...
const LinkedInPlaceholder = (_a) => {
    var { url, linkText = 'View this post on LinkedIn', imageUrl } = _a, divProps = __rest(_a, ["url", "linkText", "imageUrl"]);
    return (react_1.default.createElement("div", Object.assign({}, divProps, { className: (0, classnames_1.default)(divProps.className), style: Object.assign({ overflow: 'hidden', border: 'solid 1px rgba(0, 0, 0, 0.15)', borderRadius: 8, boxSizing: 'border-box' }, divProps.style) }),
...
exports.LinkedInPlaceholder = LinkedInPlaceholder;
