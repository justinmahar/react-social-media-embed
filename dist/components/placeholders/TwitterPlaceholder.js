...
exports.TwitterPlaceholder = void 0;
...
const TwitterPlaceholder = (_a) => {
    var { url, linkText = 'View this post on Twitter', imageUrl } = _a, divProps = __rest(_a, ["url", "linkText", "imageUrl"]);
    return (react_1.default.createElement("div", Object.assign({}, divProps, { className: (0, classnames_1.default)(divProps.className), style: Object.assign({ overflow: 'hidden', border: 'solid 1px #c9d4d9', borderRadius: 12, boxSizing: 'border-box' }, divProps.style) }),
...
exports.TwitterPlaceholder = TwitterPlaceholder;
