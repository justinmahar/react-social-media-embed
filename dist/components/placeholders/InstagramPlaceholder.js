...
exports.InstagramPlaceholder = void 0;
...
const InstagramPlaceholder = (_a) => {
    var { url, linkText = 'View this post on Instagram', imageUrl } = _a, divProps = __rest(_a, ["url", "linkText", "imageUrl"]);
    return (react_1.default.createElement("div", Object.assign({}, divProps, { className: (0, classnames_1.default)(divProps.className), style: Object.assign({ overflow: 'hidden', background: '#FFF', border: '1px solid #dee2e6', borderRadius: 3, boxSizing: 'border-box', maxWidth: '540px', minWidth: '326px', padding: 0, width: 'calc(100% - 2px)' }, divProps.style) }),
        react_1.default.createElement("a", { href: url, style: { textDecoration: 'none' }, target: "_blank", rel: "noopener noreferrer" },
            ...
            !imageUrl && (react_1.default.createElement(PlaceholderTextBody_1.PlaceholderTextBody, null,
                react_1.default.createElement(InstagramLogo, null),
            ...
            react_1.default.createElement(FooterPlaceholder_1.PlaceholderFooter, { style: { paddingBottom: 16 } },
                imageUrl && react_1.default.createElement(FooterLinkText_1.FooterLinkText, null, linkText),
...
exports.InstagramPlaceholder = InstagramPlaceholder;
const InstagramLogo = () => {
