        ...
        react_1.default.createElement("div", { style: {
            ...
            react_1.default.createElement("div", { className: "instagram-media-pre-embed", id: uuidRef.current, style: { padding: '16px 0' } },
                react_1.default.createElement("a", { href: `${url}?utm_source=ig_embed&utm_campaign=loading`, style: {
                    ...
                    react_1.default.createElement(IGBody, { url: url, linkText: 'View this post' }),
                    react_1.default.createElement(IGFooter, null))))));
};
exports.IGPlaceholder = IGPlaceholder;
const IGHeader = () => {
    return (react_1.default.createElement("div", { className: "instagram-media-header", style: { display: 'flex', flexDirection: 'row', alignItems: 'center', padding: '0 16px' } },
        react_1.default.createElement("div", { style: {
        ...
        react_1.default.createElement("div", { style: { display: 'flex', flexDirection: 'column', flexGrow: 1, justifyContent: 'center' } },
            react_1.default.createElement("div", { style: {
                    backgroundColor: '#F4F4F4',
                    borderRadius: '4px',
                    flexGrow: 0,
...
const IGBody = (props) => {
    return (react_1.default.createElement("div", { className: "instagram-media-body" },
        react_1.default.createElement("div", null,
            react_1.default.createElement("div", { style: { padding: '16% 0' } }),
            react_1.default.createElement("div", { style: { display: 'block', height: '50px', margin: '0 auto 12px', width: '50px' } },
                !props.linkTextDisabled && !!props.linkText && (react_1.default.createElement("svg", { width: "50px", height: "50px", viewBox: "0 0 60 60", version: "1.1", xmlns: "https://www.w3.org/2000/svg", xmlnsXlink: "https://www.w3.org/1999/xlink" },
            ...
            react_1.default.createElement("div", { style: { paddingTop: '8px' } },
                react_1.default.createElement("div", { style: {
                    ...
                    props.linkTextDisabled && react_1.default.createElement("span", { style: { visibility: 'hidden' } }, "\u00A0"))),
            react_1.default.createElement("div", { style: { padding: '15.5% 0' } }))));
};
const IGFooter = () => {
    return (react_1.default.createElement("div", { className: "instagram-media-footer", style: { padding: '0 16px' } },
        react_1.default.createElement("div", { style: { display: 'flex', flexDirection: 'row', marginBottom: '14px', alignItems: 'center' } },
            react_1.default.createElement("div", null,
                react_1.default.createElement("div", { style: {
                        backgroundColor: '#F4F4F4',
                        borderRadius: '50%',
            ...
            react_1.default.createElement("div", { style: { marginLeft: '8px' } },
                react_1.default.createElement("div", { style: {
                        backgroundColor: '#F4F4F4',
                        borderRadius: '50%',
                        flexGrow: 0,
        ...
        react_1.default.createElement("div", { style: {
            ...
            react_1.default.createElement("div", { style: { backgroundColor: '#F4F4F4', borderRadius: '4px', flexGrow: 0, height: '14px', width: '144px' } }))));
};
