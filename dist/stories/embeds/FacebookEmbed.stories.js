...
const MainExampleTemplate = (args) =>
  react_1.default.createElement(
    EmbedToggler_1.EmbedToggler,
    { defaultToggledOn: true },
    react_1.default.createElement(FacebookEmbed_1.FacebookEmbed, Object.assign({}, args)),
  );
const ToggledOffTemplate = (args) =>
  react_1.default.createElement(
    EmbedToggler_1.EmbedToggler,
    { defaultToggledOn: typeof window !== 'undefined' && window.location.href.includes('localhost') },
    react_1.default.createElement(FacebookEmbed_1.FacebookEmbed, Object.assign({}, args)),
  );
exports.Example = MainExampleTemplate.bind({});
exports.Example.args = {
  url: photoUrl,
  width: 325,
};
exports.TextPostExample = MainExampleTemplate.bind({});
exports.TextPostExample.args = {
  url: textUrl,
  width: 325,
};
exports.VideoPostExample = MainExampleTemplate.bind({});
exports.VideoPostExample.args = {
  url: videoUrl,
  width: 325,
};
exports.LinkPostExampleWidth550 = MainExampleTemplate.bind({});
...
exports.CustomPlaceholder.args = {
  url: photoUrl,
  width: 325,
  embedPlaceholder: react_1.default.createElement(
    'div',
    {
      style: {
        width: 325,
