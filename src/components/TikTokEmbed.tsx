...
export const TikTokEmbed = ({
  ...
  return (
    <TikTokWrapperDiv style={{ width: '100%', maxWidth: 605, minWidth: 325, minHeight: 500, ...divProps.style }}>
      <div
      ...
      >
        ...
        <blockquote
          className="tiktok-embed d-flex justify-content-center w-100"
          cite={url}
        ...
        >
          ...
          >
            <a
              ...
              rel="noreferrer"
            >
              <TikTokHeader showSpinner={!spinnerDisabled} />
              <TikTokBody
...
const TikTokHeader = (props: { showSpinner: boolean }) => {
  return (
    <div
      className="tiktok-embed-header"
...
const TikTokBody = (props: TikTokBodyProps) => {
  return (
    <TikTokBodyDiv
...
const TikTokFooter = () => {
  return (
    <div className="tiktok-embed-footer" style={{ padding: '0 16px' }}>
...
interface TikTokBodyDivProps extends DivPropsWithoutRef {
  backgroundBlurAnimationDuration: number;
}

const TikTokBodyDiv: (props: TikTokBodyDivProps) => JSX.Element = styled.div`
  .backdrop-blur {
    backdrop-filter: blur(4px);
    -webkit-backdrop-filter: blur(4px);
    animation: bgBlur ${(props: TikTokBodyDivProps) => props.backgroundBlurAnimationDuration / 1000}s ease 1;
  }
...
const TikTokWrapperDiv = styled.div`
  & > div {
    width: 100%;
  }
`;
